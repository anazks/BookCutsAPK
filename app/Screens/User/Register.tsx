...
export default function OtpRegister() {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      const response = await otpLogin(payload);
      if (response.success) {
        Alert.alert('OTP Sent', 'Please enter the code sent to your mobile', [
          { text: 'OK', onPress: () => setStep(2) }
        ]);
      } else {
  ...
  return (
    <View style={styles.container}>
      ...
      {/* ABSTRACT BACKGROUND (Matching Home/Login) */}
        ...
        >
          ...
          >
            <View style={styles.headerSection}>
              ...
              <Text style={styles.subtitleText}>
                {step === 1 
                  ? 'Join the premium grooming community' 
                  : `Enter the 6-digit code sent to +91 ${formData.mobileNo}`
                }
              </Text>
            </View>
              ...
              {step === 1 ? (
                <>
                  ...
                  <View style={styles.inputGroup}>
                    ...
                    <View style={[styles.glassInput, errors.firstName && styles.errorBorder]}>
                  ...
                  <View style={styles.inputGroup}>
                    ...
                    <View style={[styles.glassInput, errors.lastName && styles.errorBorder]}>
                      <MaterialIcons name="person-outline" size={20} color="rgba(255,255,255,0.5)" />
                      <TextInput
                        style={styles.input}
                  ...
                  <View style={styles.inputGroup}>
                    ...
                    <View style={[styles.glassInput, errors.mobileNo && styles.errorBorder]}>
                ...
                <View style={styles.inputGroup}>
                  ...
                  <View style={styles.glassInput}>
                    <MaterialIcons name="sms" size={20} color="rgba(255,255,255,0.5)" />
                    <TextInput
                      style={styles.input}
...
const styles = StyleSheet.create({
  ...
  errorBorder: { borderColor: 'rgba(239, 68, 68, 0.5)' },
  input: { flex: 1, color: '#FFFFFF', fontSize: 16, marginLeft: 12, fontWeight: '500' },
  countryCode: { color: '#3B82F6', fontWeight: '700', fontSize: 16, marginRight: 5 },
  
  resendContainer: { marginTop: 15, alignSelf: 'center' },
  resendText: { color: '#3B82F6', fontSize: 14, fontWeight: '600', textDecorationLine: 'underline' },
