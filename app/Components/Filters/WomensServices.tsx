...
const womensServices = [
  {
    id: '1',
    name: 'Hair Styling',
    apiName: 'Hair Styling',
    icon: 'color-wand-outline' as const,
    desc: 'Premium cuts & colors',
    tag: 'Popular',
    image: 'https://images.pexels.com/photos/3993311/pexels-photo-3993311.jpeg?auto=compress&cs=tinysrgb&w=500',
    accent: '#DB2777',
    lightBg: '#FDF2F8',
  },
  {
    id: '2',
    name: 'Beauty Parlor',
    apiName: 'Beauty Parlor',
    icon: 'flower-outline' as const,
    desc: 'Luxury treatments',
    tag: 'Trending',
  ...
  },
  {
    id: '3',
    name: 'Bridal Makeup',
    apiName: 'Bridal Makeup',
    icon: 'sparkles-outline' as const,
    desc: 'Your special day',
    tag: 'Special',
...
export default function WomensServices({
  ...
  const selectedItem = womensServices.find((s) => s.apiName === selected);
...
const styles = StyleSheet.create({
  ...
  headerDot: {
    ...
    height: 16,
    borderRadius: 2,
    backgroundColor: '#DB2777',   // pink accent to match the section theme
  },
  headerTitle: {
    fontSize: 15,
    fontWeight: '700',
